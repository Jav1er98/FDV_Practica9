...
public class Scroll : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        background.transform.Translate(Time.deltaTime * speed,0,0);
        
        background2.transform.Translate(Time.deltaTime * speed, 0, 0);
        ...
        else if (background2.transform.position.x + anchoFondo2.sprite.bounds.size.x < camara.transform.position.x)
